...
import { fetchAvailability, saveTransfer, fetchBinMasterData, fetchHoldingData, fetchCompletedTransfer } from "../../../api/api";
import { ToastContainer, toast } from "react-toastify";
import "react-toastify/dist/ReactToastify.css";
import { XCircleIcon, RefreshIcon, FilterIcon, XIcon } from "@heroicons/react/outline";
...
const TransferPage = () => {
    ...
    const fetchCompletedTransfersData = async () => {
        try {
            const data = await fetchCompletedTransfer();
    ...
    const handleTransferSubmit = async () => {
        ...
        try {
            await saveTransfer(transferPayload);
                    ...
                    >
                        ...
                        <div className="flex flex-col gap-3">
                            ...
                            <div className="flex gap-2">
                                <button
                                    onClick={() => { setAvailabilityFilter(null); setShowAvailabilityFilterPopup(false); }}
